...
public class EditCExprience extends AppCompatActivity {

    ProgressDialog progressDialog;
    final ArrayList<EditCExprience.SkillsClass> skillslist = new ArrayList<EditCExprience.SkillsClass>();
    public static String skillsList="";
    public static String subskillsList="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_cexprience);

        // Progress dialog
        progressDialog = new ProgressDialog(EditCExprience.this);
        ...
        btn_action = (Button) findViewById(R.id.edit_skill);
            ...
            public void onClick(View view) {
               // System.out.println("DDD=="+skillstext.getText().toString());
                ...
                if(!skillstext.getText().toString().equals("Select Skills")) {
                    ...
                    String url = CONFIG_URL + "/updatecareer/id/" + USER_ID;
...
//                        params.put("proficiency", prof);
                    ...
                    Toast.makeText(EditCExprience.this,
        ...
        skillslayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(EditCExprience.this);
                ...
                for (int i = 0; i < skills.length; i++) {
                    ...
                    EditCExprience.SkillsClass EatingClass = new EditCExprience.SkillsClass();
...
//                            skillslist.get(0).setSelected(false);
                ...
                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        ArrayList<EditCExprience.SkillsClass> selectedList = new ArrayList<>();
                        // System.out.println("select"+skillslist.size());
                        for (int i = 0; i < skillslist.size(); i++) {
                            EditCExprience.SkillsClass EatingClass = skillslist.get(i);
    ...
    private void getLoadData()
    {
        ...
        AppSingleton.getInstance(EditCExprience.this).addToRequestQueue(strReq, cancel_req_tag);
    ...
    private void getSelectedData()
    {
        ...
        String URL_FOR_DETAIL = CONFIG_URL+"/getskills/profile_id/" + PROFILE_ID+"/category_id/"+cat_id;
