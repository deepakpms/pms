...
import com.cvvid.adaptors.employer.EUpgradeAdaptor;
...
public class EmployerUpgrade extends AppCompatActivity {

    private RecyclerView recyclerView;
    private TextView tvEmptyTextView;
    private EUpgradeAdaptor adapter;
    ArrayList<EmployerUpgrade.SimplePlan> planArrayList;
    private View view;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_employer_upgrade);
        ...
        new EmployerUpgrade.Async().execute();
    ...
    public void loadSessionData()
    {
        ...
        final StringRequest strReq = new StringRequest(Request.Method.GET,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(EmployerUpgrade.this,error.getMessage(), Toast.LENGTH_LONG).show();
                hideDialog();
            }
        });
//
    ...
    public void showRcv(ArrayList<EmployerUpgrade.SimplePlan> plans){

        adapter = new EUpgradeAdaptor(this, plans);
        ...
        recyclerView.addItemDecoration(new EmployerUpgrade.GridSpacingItemDecoration(1, dpToPx(10), true));
        recyclerView.setItemAnimator(new DefaultItemAnimator());
        recyclerView.setAdapter(adapter);
    }

    public class Async extends AsyncTask<Void,String,ArrayList<EmployerUpgrade.SimplePlan>> {

        @TargetApi(Build.VERSION_CODES.KITKAT)
        @Override
        protected ArrayList<EmployerUpgrade.SimplePlan> doInBackground(Void... params) {

            try {
                String line, newjson = "";
                URL url = new URL(CONFIG_URL+"/getEPlan");
                try (BufferedReader reader = new BufferedReader(new InputStreamReader(url.openStream(), "UTF-8"))) {
                    ...
                    for (int i=0;i<plans.length();i++){
                        ...
                        planArrayList.add(new EmployerUpgrade.SimplePlan(plan.getString("id"),plan.getInt("price"),plan.getString("name"),plan.getString("description"),plan.getString("price_suffix")));
                    }
                }
            } catch (Exception e) {
                e.printStackTrace();
        ...
        @Override
        protected void onPostExecute(final ArrayList<EmployerUpgrade.SimplePlan> plan) {
