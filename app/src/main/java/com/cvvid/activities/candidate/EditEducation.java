...
public class EditEducation extends AppCompatActivity implements
    ...
    EditText inst_field,location_field,study_field,grade_field,desc_field;
    String institution,loc,field,grade,desc,cmonth,cyear,level,USER_ID;
    // Session Manager Class
    SessionManager session;
    String eduid;
    ArrayList<Integer> year;
    public static final String URL_GET_EDUCATION = CONFIG_URL+"/fetcheducation/id/";
    public static final String URL_SAVE_EDUCATION = CONFIG_URL+"/updateeducation/id/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        displayname.setText("Edit Education");
        // Progress dialog
        ...
        ArrayAdapter<Integer> adapter =
                new ArrayAdapter<Integer>(EditEducation.this, android.R.layout.simple_spinner_item, year);
...
//        session
        ...
        validation.addValidation(EditEducation.this, R.id.institution, RegexTemplate.NOT_EMPTY, R.string.institution);

        Intent i = getIntent();
        eduid = i.getStringExtra("eduid");
        setValues(eduid);
        /**
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(validation.validate())
                {
                    ...
                    String completion_date = cyear + "-" + cmonth + "-01";

                    saveEducation(completion_date,level,institution,loc,field,grade,desc,eduid);
                }
...
//            input_postcode.setFocusable(false);
    ...
    public void saveEducation(final String completion_date,final String level, final String institution,final String loc, final String field,final  String grade, final  String desc,final String edu )
    {
        String cancel_req_tag = "education";
        progressDialog.setMessage("Please wait a moment");
        showDialog();

        String url  = URL_SAVE_EDUCATION + edu;
        StringRequest strReq = new StringRequest(Request.Method.POST,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("completion_date", completion_date );
    ...
    private void setValues(String edu)
    {
        String cancel_req_tag = "edit";

        String URL_FOR_DETAIL = URL_GET_EDUCATION + edu;
        ...
        final StringRequest strReq = new StringRequest(Request.Method.GET,
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    String inst = c.getString("institution");
                    String loc = c.getString("location");

                    String field = c.getString("field");
                    String level = c.getString("level");
                    String mcompdate = c.getString("completionmonth");
                    String ycompdate = c.getString("completionyear");
                    String grade = c.getString("grade");
                    String desc = c.getString("description");

                    inst_field.setText(inst);
                    location_field.setText(loc);
                    study_field.setText(field);

                    if(level.equalsIgnoreCase("GCSE"))
                        level_spinner.setSelection(0);
                    if(level.equalsIgnoreCase("A Levels"))
                        level_spinner.setSelection(1);
                    if(level.equalsIgnoreCase("UnderGraduate"))
                        level_spinner.setSelection(2);
                    if(level.equalsIgnoreCase("PostGraduate"))
                        level_spinner.setSelection(3);
                    if(level.equalsIgnoreCase("Vocational"))
                        level_spinner.setSelection(4);
                    ...
                    if(mcompdate != "")
                        completion_month.setSelection(Integer.parseInt(mcompdate)-1);
                    ...
                    for (int i = 0; i < year.size(); i++) {
                        ...
                        if (year.get(i) == Integer.parseInt(ycompdate))
                            completion_year.setSelection(i);
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(EditEducation.this,
                        error.getMessage(), Toast.LENGTH_LONG).show();
                hideDialog();
            }
        });
//
        AppSingleton.getInstance(EditEducation.this).addToRequestQueue(strReq, cancel_req_tag);
    }
