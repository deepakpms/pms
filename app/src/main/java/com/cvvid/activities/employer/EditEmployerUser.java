...
import static com.cvvid.apicall.LOCATION_URL.URL_EDIT_EMPLOYERUSER;
import static com.cvvid.apicall.LOCATION_URL.URL_GET_EMPLOYERUSER;

public class EditEmployerUser extends AppCompatActivity {
...
//        session
        ...
        Intent i = getIntent();
        euserid = i.getStringExtra("euserid");
        setValues(euserid);
        ...
        validation.addValidation(EditEmployerUser.this, R.id.forename, RegexTemplate.NOT_EMPTY, R.string.fnameerr);
        validation.addValidation(EditEmployerUser.this, R.id.surname, RegexTemplate.NOT_EMPTY, R.string.snameerr);
        validation.addValidation(EditEmployerUser.this, R.id.email, RegexTemplate.NOT_EMPTY, R.string.emailerr);
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(validation.validate())
                {
                    ...
                    updateEmployerUser(fname,sname,email,pwd,cpwd);
                }
    ...
    public void updateEmployerUser(final String fname,final String sname,final String email,final String pwd, final String cpwd)
    {
        String cancel_req_tag = "employer user";
        progressDialog.setMessage("Please wait a moment");
        showDialog();

        String url  = URL_EDIT_EMPLOYERUSER + euserid;
    ...
    private void setValues(String euser)
    {
        String cancel_req_tag = "edit";

        String URL_FOR_DETAIL = URL_GET_EMPLOYERUSER + euser;
        ...
        final StringRequest strReq = new StringRequest(Request.Method.GET,
            ...
            public void onResponse(String response) {
                ...
                Log.d(TAG, "Employer User Response: " + response.toString());
                ...
                try {
                    ...
                    String fnames = c.getString("forenames");
                    String snames = c.getString("surname");
                    String emails = c.getString("email");

                    forename_field.setText(fnames);
                    surname_field.setText(snames);
                    email_field.setText(emails);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(EditEmployerUser.this,
                        error.getMessage(), Toast.LENGTH_LONG).show();
                hideDialog();
            }
        });
//
        AppSingleton.getInstance(EditEmployerUser.this).addToRequestQueue(strReq, cancel_req_tag);
    }
