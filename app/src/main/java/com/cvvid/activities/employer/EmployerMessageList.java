...
import com.cvvid.adaptors.employer.EChatArrayAdapter;
...
public class EmployerMessageList extends AppCompatActivity {

    private static final String TAG = "ChatActivity";

    private EChatArrayAdapter chatArrayAdapter;
    private List<ChatMessageEmployer> chatList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_employer_message_list);
...
//        listView = (ListView) findViewById(R.id.msgview);
        ...
        chatArrayAdapter =  new EChatArrayAdapter(this, chatList,USER_ID,msg_to, CON_ID);
    ...
    public void getResponse(int method, String url, JSONObject jsonValue, final CandidateMessageList.VolleyCallback callback) {
        ...
        StringRequest strreq = new StringRequest(Request.Method.GET, url, new Response.Listener < String > () {
            ...
            public void onErrorResponse(VolleyError e) {
                e.printStackTrace();
                Toast.makeText(EmployerMessageList.this, e + "error", Toast.LENGTH_LONG).show();
            }
        });
    ...
    {
        new EmployerMessageList.saveMessage(user_id, conversation_id,msgto,message).execute();
        chatText.setText("");
    }
    ...
    public class saveMessage extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pd = new ProgressDialog(EmployerMessageList.this);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < jUser.length(); i++)
                    {
                        ...
                        chatList.add(0, new ChatMessageEmployer(c.getString("id"),c.getString("conversation_id"),c.getString("user_id"),c.getString("name"),c.getString("message"),c.getString("created_at")));
                    }
