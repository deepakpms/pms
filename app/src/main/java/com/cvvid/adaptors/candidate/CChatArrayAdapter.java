...
public class CChatArrayAdapter extends RecyclerView.Adapter<CChatArrayAdapter.MyViewHolder> {

    private List<ChatMessageCandidate> chatMessageList;
    ...
    public CChatArrayAdapter(Context mContext, List<ChatMessageCandidate> chatMessageList, String user_id, String msg_to,String conversation_id) {
    ...
    void refresh() {
        ...
        getResponse(Request.Method.GET, url, null,
                new CChatArrayAdapter.VolleyCallback() {
                    @Override
                    public void onSuccessResponse(String result) {
                        try {
                            ...
                            for (int i = 0; i < jUser.length(); i++)
                            {
                                ...
                                chatMessageList.add(new ChatMessageCandidate(c.getString("id"),c.getString("conversation_id"),c.getString("user_id"),c.getString("name"),c.getString("message"),c.getString("created_at")));
                            }
    ...
    public void getResponse(int method, String url, JSONObject jsonValue, final CChatArrayAdapter.VolleyCallback callback) {
    ...
    @Override
    public CChatArrayAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView;
        ...
        if(viewType == VIEW_TYPE_MESSAGE_SENT)
        {
            ...
            return new CChatArrayAdapter.MyViewHolder(itemView);
    ...
    @Override
    public void onBindViewHolder(final CChatArrayAdapter.MyViewHolder holder, int position) {
        final ChatMessageCandidate album = chatMessageList.get(position);
