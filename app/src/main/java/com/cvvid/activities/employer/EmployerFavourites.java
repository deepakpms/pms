...
import com.cvvid.adaptors.employer.EmployerFavouritesAdapter;
...
public class EmployerFavourites extends AppCompatActivity {

    private RecyclerView recyclerView;
    private TextView tvEmptyTextView;
    private EmployerFavouritesAdapter adapter;
    private List<EmployerFavouritesModel> favViewList;
    private View view;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_employer_favourites);
        ...
        adapter = new EmployerFavouritesAdapter(this, favViewList);

        RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(this, 2);
        recyclerView.setLayoutManager(mLayoutManager);
        recyclerView.addItemDecoration(new EmployerFavourites.GridSpacingItemDecoration(2, dpToPx(10), true));
       ...
       // Tag used to cancel the request
        ...
        final StringRequest strReq = new StringRequest(Request.Method.GET,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(EmployerFavourites.this,error.getMessage(), Toast.LENGTH_LONG).show();
                hideDialog();
            }
        });
//
    ...
    public void loadData(String profile_id) {
        ...
        String proifle = CONFIG_URL+"/getallprofilefavourites/profile_id/"+profile_id;
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < jUser.length(); i++)
                    {
                        ...
                        item = new CandidateFavouritesModel();
                        ...
                        favViewList.add(new EmployerFavouritesModel("", c.getString("slug"),c.getString("photo_id"), c.getString("photo")));
                    }
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(EmployerFavourites.this);
