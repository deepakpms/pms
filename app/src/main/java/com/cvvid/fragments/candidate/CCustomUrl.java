 ...
 */
public class CCustomUrl extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_ccustom_url, container, false);
...
//        session
    ...
    private void saveChanges(final String USER_ID, final String customurl)
    {
        ...
        String URL_FOR_DETAIL = CONFIG_URL+"/updateslug/id/" + USER_ID;
    ...
    private void getLoadData(final String USER_ID, final View view)
    {
        ...
        String URL_FOR_DETAIL = CONFIG_URL+"/fetchcandidatedetails/id/" + USER_ID;
