...
public class ProfilesViews extends AppCompatActivity {

    private RecyclerView recyclerView;
    private TextView tvEmptyTextView;
    private ProfilesViewsAdapter adapter;
    private List<ProfilesViewsModel> profileViewList;
    private View view;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_profiles_views);
        ...
        adapter = new ProfilesViewsAdapter(this, profileViewList);
...
//
//                    Picasso.with(ProfilesViews.this).load(cover)
//                            .fit()
//                            .centerCrop()
...
//                            .into(coverphoto);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(ProfilesViews.this,error.getMessage(), Toast.LENGTH_LONG).show();
                hideDialog();
            }
        });
//
    ...
    public void loadData(String PROFILE_ID) {
        ...
        String proifle = CONFIG_URL+"/getallprofileviews/profile_id/"+PROFILE_ID;
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < jUser.length(); i++)
                    {
                        ...
                        item = new ProfilesViewsModel();

                        item.setId(c.getString("id"));
                        item.setForenames(c.getString("forenames"));
                        item.setView_count(c.getString("view_count"));
                        item.setSurname(c.getString("surname"));
                        item.setCurrent_job(c.getString("current_job"));
                        item.setLocation(c.getString("location"));

//                        TextView slugurl = (TextView)findViewById(R.id.slugurl);
//                        slugurl.setText(c.getString("surname"));

                        profileViewList.add(new ProfilesViewsModel(c.getString("id"), c.getString("forenames"),c.getString("surname"), c.getString("current_job"), c.getString("location"),c.getString("view_count")));

                    }

                    if(profileViewList.isEmpty()){
                    ...
                    System.out.println("count"+profileViewList.size());
                ...
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        System.out.println("ERRRRR"+error.getMessage());
                    }
                });
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(ProfilesViews.this);
