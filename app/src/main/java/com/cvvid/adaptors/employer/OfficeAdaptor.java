...
public class OfficeAdaptor extends RecyclerSwipeAdapter<OfficeAdaptor.SimpleViewHolder> {

    private Context mContext;
    private ArrayList<EmployerOfficeModel> documentList;
    ProgressDialog progressDialog;
    ViewGroup pp;
    Activity act;
    SimpleViewHolder viewHolders;
    String URL_FOR_DELETE = CONFIG_URL+"/deleteoffice/id/";

    public OfficeAdaptor(Context context, ArrayList<EmployerOfficeModel> objects) {
    ...
    public void onBindViewHolder(final SimpleViewHolder viewHolder, final int position) {
        ...
        final EmployerOfficeModel item = documentList.get(position);
...
//        });
        ...
        viewHolder.Edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                i.putExtra("empoffid", item.getId());
                ...
                alertDialogBuilderUserInput
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialogBox, int id) {
                                deleteOffice(item.getId(), position);
...
//        public ImageButton btnLocation;
    ...
    public void deleteOffice(final String id, final int position)
    {
        // Progress dialog
