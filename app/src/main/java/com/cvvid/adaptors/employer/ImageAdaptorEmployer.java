...
public class ImageAdaptorEmployer extends RecyclerView.Adapter<ImageAdaptorEmployer.ViewHolder> {
    ...
    public ImageAdaptorEmployer(Context context, List<ImageListModel> list) {
    ...
    @Override
    public ImageAdaptorEmployer.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ImageAdaptorEmployer.ViewHolder viewHolder = new ImageAdaptorEmployer.ViewHolder(contactView);
    ...
    @Override
    public void onBindViewHolder(ImageAdaptorEmployer.ViewHolder holder, final int position) {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(status == 200){
                                ...
                                Intent i = new Intent(mContext, EmployerProfile.class);
