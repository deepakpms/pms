...
import com.cvvid.adaptors.candidate.LanguageAdaptor;
import com.cvvid.R;
import com.cvvid.activities.candidate.AddLanguage;
...
public class LanguageFragment extends Fragment {
    ...
    private ArrayList<LanguageModel> mDataSet;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        addhobby.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getActivity() ,AddLanguage.class);
    ...
    public void loadData(String USER_ID) {
        ...
        String url = CONFIG_URL+"/getlanguage/id/"+USER_ID;
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < jUser.length(); i++)
                    {
                        ...
                        item.setProficiency(c.getString("proficiency"));

                        mDataSet.add(new LanguageModel(c.getString("id"), c.getString("name"), c.getString("proficiency")));
                    }
                    ...
                    LanguageAdaptor mAdapter = new LanguageAdaptor(getContext(), mDataSet);

                    ((LanguageAdaptor) mAdapter).setMode(Attributes.Mode.Single);
