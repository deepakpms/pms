...
import com.cvvid.adaptors.employer.ImageAdaptorEmployer;
...
import com.cvvid.fragments.candidate.DocumentFragment;
...
public class EmployerProfileFragment extends Fragment {
    ...
    {
        EmployerProfileFragment myFragment = new EmployerProfileFragment();
        return myFragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        madapter.AddFragmentPage(new VideoFragment(), "Company Video");
        madapter.AddFragmentPage(new CompanyBackgroundFragment(), "Company Background");
        madapter.AddFragmentPage(new EmployerUserFragment(), "Users");
        madapter.AddFragmentPage(new OfficeFragment(), "Offices ");
...
//                        .show();
            ...
            if (resultCode == RESULT_OK) {
                ...
                new EmployerProfileFragment.UploadFileToServer(imagepath).execute();
...
//                        .show();
    ...
    private class UploadFileToServer extends AsyncTask<Void, Integer, String> {
        ...
        private String uploadFile() {
            ...
            System.out.println("downloadimage"+IMAGE_UPLOAD+EMPLOYER_ID);

            HttpPost httppost = new HttpPost(IMAGE_UPLOAD+EMPLOYER_ID);
            ...
            try {
                ...
                entity.addPart("model_type", new StringBody("App\\\\Employer"));
                entity.addPart("model_id", new StringBody(EMPLOYER_ID));
