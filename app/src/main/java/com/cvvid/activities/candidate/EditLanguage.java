...
public class EditLanguage extends AppCompatActivity {
    ...
    String langid;
    public static final String URL_GET_LANGUAGE = CONFIG_URL+"/fetchlanguage/id/";
    public static final String URL_SAVE_LANGUAGE = CONFIG_URL+"/updatelanguage/id/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        displayname.setText("Edit Language");
...
//        session
        ...
        validation.addValidation(EditLanguage.this, R.id.language, RegexTemplate.NOT_EMPTY, R.string.language);

        Intent i = getIntent();
        langid = i.getStringExtra("langid");
        setValues(langid);
    ...
    public void saveLanguage(final String lang, final  String prof,final String lang_id )
    {
        String cancel_req_tag = "language";
        progressDialog.setMessage("Please wait a moment");
        showDialog();

        String url  = URL_SAVE_LANGUAGE + lang_id;
    ...
    private void setValues(String hob)
    {
        ...
        String URL_FOR_DETAIL = URL_GET_LANGUAGE + hob;
        ...
        final StringRequest strReq = new StringRequest(Request.Method.GET,
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    String prof = c.getString("proficiency");

                    lang_field.setText(name);
                    if(prof.equalsIgnoreCase("Basic"))
                        prof_field.setSelection(0);
                    if(prof.equalsIgnoreCase("Intermediate"))
                        prof_field.setSelection(1);
                    if(prof.equalsIgnoreCase("Expert"))
                        prof_field.setSelection(2);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(EditLanguage.this,
                        error.getMessage(), Toast.LENGTH_LONG).show();
                hideDialog();
            }
        });
//
        AppSingleton.getInstance(EditLanguage.this).addToRequestQueue(strReq, cancel_req_tag);
    }
