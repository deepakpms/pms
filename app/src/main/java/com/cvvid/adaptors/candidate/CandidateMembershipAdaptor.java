...
public class CandidateMembershipAdaptor extends RecyclerView.Adapter<CandidateMembershipAdaptor.ViewHolder> {

    private Context mContext;
    private ArrayList<CandidateMembershipModel> mList;
    public CandidateMembershipAdaptor(Context context, ArrayList<CandidateMembershipModel> list){
        mContext = context;
        mList = list;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        CandidateMembershipModel contact = mList.get(position);
