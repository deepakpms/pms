...
public class DocumentFragment extends Fragment {
    ...
    private ArrayList<DocumentModel> mDataSet;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button addvideo = (Button)view.findViewById(R.id.btn_create);
        ...
        addvideo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getActivity() ,AddDocument.class);
    ...
    public void loadData(String USER_ID) {
        ...
        String url = CONFIG_URL+"/getallprofiledocumentation/id/"+USER_ID;
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < jUser.length(); i++)
                    {
                        ...
                        item.setName(c.getString("docname"));
                        item.setCategory(c.getString("category"));

                        mDataSet.add(new DocumentModel(c.getString("id"), c.getString("docname"), c.getString("category")));
                    }
                    ...
                    DocumentAdaptor mAdapter = new DocumentAdaptor(getContext(), mDataSet);

                    ((DocumentAdaptor) mAdapter).setMode(Attributes.Mode.Single);
