...
public class AddHobbies extends AppCompatActivity {
    ...
    // LogCat tag
    private static final String TAG = AddHobbies.class.getSimpleName();
    ...
    public static final String URL_SAVE_HOBBY = CONFIG_URL+"/createhobbies/id/";
...
//        session
        ...
        validation.addValidation(AddHobbies.this, R.id.hobby, RegexTemplate.NOT_EMPTY, R.string.hobby);
    ...
    public void saveHobby(final String hobby, final  String desc )
    {
        String cancel_req_tag = "hobby";
        progressDialog.setMessage("Please wait a moment");
        showDialog();

        String url  = URL_SAVE_HOBBY + USER_ID;
