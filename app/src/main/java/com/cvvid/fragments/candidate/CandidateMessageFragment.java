 ...
 */
public class CandidateMessageFragment extends Fragment {

    private TextView tvEmptyTextView;
    private RecyclerView mRecyclerView;
    private ArrayList<CandidateMessageUserList> mDataSet;
    ...
    public CandidateMessageFragment() {
        // Required empty public constructor
    }

    public static Fragment newInstance()
    {
        CandidateMessageFragment myFragment = new CandidateMessageFragment();
        return myFragment;
    }
            ...
            public void onResponse(String response) {
                ...
                try {
                   ...
                   String res = forReplacementString(response);
                    ...
                    CandidateMessageUserList item;

                    for (int i = 0; i < jUser.length(); i++)
                    {
                        JSONObject c = jUser.getJSONObject(i);

                        item = new CandidateMessageUserList();
                        ...
                        mDataSet.add(new CandidateMessageUserList(c.getString("conversation_id"), c.getString("user_id"), c.getString("name"), c.getString("subject"),c.getString("message"),c.getString("created_at")));
                    }
                    ...
                    CandidateMessageUserAdaptor mAdapter = new CandidateMessageUserAdaptor(getContext(), mDataSet);
