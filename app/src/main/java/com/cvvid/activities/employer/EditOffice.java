...
public class EditOffice extends AppCompatActivity implements
    ...
    private static final String TAG = EditOffice.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent ie = getIntent();
        empoffid = ie.getStringExtra("empoffid");
        setData(empoffid);
        ...
        validation.addValidation(EditOffice.this, R.id.postcode, RegexTemplate.NOT_EMPTY, R.string.posterr);
    ...
    private void setData(final String empoffid)
    {
        ...
        String URL_FOR_DETAIL = CONFIG_URL+"/fetchoffice/id/" + empoffid;
        ...
        final StringRequest strReq = new StringRequest(Request.Method.GET,
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    town.setText(c.getString("town"));
                    county.setText(c.getString("county"));
                    country.setText(c.getString("country"));

                    if(c.getString("head_office").equals("1"))
                        head_office.setChecked(true);
                    else
                        head_office.setChecked(false);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(EditOffice.this,error.getMessage(), Toast.LENGTH_LONG).show();
                hideDialog();
            }
        });
//
...
//            input_postcode.setFocusable(false);
    ...
    private void saveoffice()
    {
        if(validation.validate())
        {
            ...
            String URL_FOR_DETAIL =CONFIG_URL+"/updateofficelocation/id/" + empoffid;
