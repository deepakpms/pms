...
public class ShortlistApplications extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shortlist_applications);
        ...
        TextView shorttxt = (TextView)findViewById(R.id.intercount);

        HorizontalScrollView s =
                (HorizontalScrollView) findViewById(R.id.horizontalScrollView1);
        s.fullScroll(HorizontalScrollView.FOCUS_RIGHT);

        shorttxt.setSelected(true);
        shorttxt.requestFocusFromTouch();
...
//                        + "/" + detailInfo.getEmail(), Toast.LENGTH_LONG).show();
        ...
        applicationcount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(ShortlistApplications.this, ViewApplications.class);
        ...
        shortcount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(ShortlistApplications.this, ShortlistApplications.class);
                i.putExtra("jobid", jobid);
                startActivity(i);
            }
        });
        ...
        intercount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(ShortlistApplications.this, IntervieweesApplications.class);
                i.putExtra("jobid", jobid);
                startActivity(i);
            }
        });
        ...
        questions.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(ShortlistApplications.this, EQuestionsList.class);
                i.putExtra("jobid", jobid);
                startActivity(i);
            }
        });
        ...
        answers.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(ShortlistApplications.this, EAnswersList.class);
                i.putExtra("jobid", jobid);
                startActivity(i);
            }
        });
    ...
    private void openPopup(final String app_id)
    {
        ...
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(ShortlistApplications.this);
        ...
        String[] arraySpinner = new String[] {
                "Shortlisted", "Invite for Interview", "Reject"
        };
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                switch (selectedClass)
                {
                    ...
                    case "Invite for Interview":
                        Intent i = new Intent(ShortlistApplications.this, InviteforInterview.class);
                        i.putExtra("jobapplicationid", app_id);
                        i.putExtra("jobid", jobid);
                        startActivity(i);
                      //  saveStatus("1", app_id);
                        //Toast.makeText(ShortlistApplications.this, "\n Class: \t " + selectedClass + "\n Div: \t" + selectedClass, Toast.LENGTH_LONG).show();
                        break;
    ...
    private void fetchResponse()
    {
        ...
        String url = CONFIG_URL+"/getalljobshortlisted/id/"+jobid;
        //Creating a string request
