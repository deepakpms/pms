...
import com.cvvid.R;
import com.cvvid.activities.candidate.CandidatePayActivity;
import com.cvvid.activities.candidate.CandidateUpgrade;
import com.cvvid.activities.candidate.CheckoutActivity;

import java.util.List;

public class CUpgradeAdaptor  extends RecyclerView.Adapter<CUpgradeAdaptor.MyViewHolder> {

    private Context mContext;
    private List<CandidateUpgrade.SimplePlan> albumList;

    public CUpgradeAdaptor(Context mContext, List<CandidateUpgrade.SimplePlan> albumList) {
        this.mContext = mContext;
        this.albumList = albumList;
    }

    @Override
    public CUpgradeAdaptor.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.cupgrade_list, parent, false);

        return new CUpgradeAdaptor.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final CUpgradeAdaptor.MyViewHolder holder, int position) {
        final CandidateUpgrade.SimplePlan album = albumList.get(position);
        ...
        holder.card_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                buyIntent.putExtra("type", "candidate");
