...
public class ImageLibraryEmployer extends AppCompatActivity {

    private RecyclerView recyclerView;
    private TextView tvEmptyTextView;
    private ImageAdaptorEmployer adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_image_library_employer);
        ...
        adapter = new ImageAdaptorEmployer(this, imageList);

        RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(this, 2);
        recyclerView.setLayoutManager(mLayoutManager);
        recyclerView.addItemDecoration(new ImageLibraryEmployer.GridSpacingItemDecoration(2, dpToPx(10), true));
