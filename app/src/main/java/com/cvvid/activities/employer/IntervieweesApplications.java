...
public class IntervieweesApplications extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_interviewees_applications);
...
//                        + "/" + detailInfo.getEmail(), Toast.LENGTH_LONG).show();
        ...
        applicationcount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(IntervieweesApplications.this, ViewApplications.class);
        ...
        shortcount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(IntervieweesApplications.this, ShortlistApplications.class);
                i.putExtra("jobid", jobid);
                startActivity(i);
            }
        });
        ...
        intercount.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(IntervieweesApplications.this, IntervieweesApplications.class);
                i.putExtra("jobid", jobid);
                startActivity(i);
            }
        });
        ...
        questions.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(IntervieweesApplications.this, EQuestionsList.class);
                i.putExtra("jobid", jobid);
                startActivity(i);
            }
        });
        ...
        answers.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(IntervieweesApplications.this, EAnswersList.class);
                i.putExtra("jobid", jobid);
                startActivity(i);
            }
        });
    ...
    private void openPopup(final String app_id)
    {
        ...
        AlertDialog.Builder mBuilder = new AlertDialog.Builder(IntervieweesApplications.this);
        ...
        String[] arraySpinner = new String[] {
                "Invited", "Interviewed", "Accept","Reject"
        };
        ...
        status.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
        {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id)
            {
                ...
                switch (selectedClass)
                {
                    ...
                    case "Accept":
                        openAcceptPopup(app_id);
                      //  Toast.makeText(IntervieweesApplications.this, "\n Class: \t " + selectedClass + "\n Div: \t" + selectedClass, Toast.LENGTH_LONG).show();
                        break;
    ...
    private void openAcceptPopup(final String app_id)
    {
        dialog.dismiss();
    ...
    private void updateAccept(final String id){
        ...
        String url = CONFIG_URL+"/acceptapplication/id/"+id;
    ...
    private void fetchResponse()
    {
        ...
        String url = CONFIG_URL+"/getalljobInterviewees/id/"+jobid;
        //Creating a string request
