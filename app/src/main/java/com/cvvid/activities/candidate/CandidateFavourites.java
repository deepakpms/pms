...
public class CandidateFavourites extends AppCompatActivity {

    private RecyclerView recyclerView;
    private TextView tvEmptyTextView;
    private CandidateFavouritesAdapter adapter;
    private List<CandidateFavouritesModel> favViewList;
    private View view;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_candidate_favourites);
        ...
        adapter = new CandidateFavouritesAdapter(this, favViewList);

        RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(this, 2);
        recyclerView.setLayoutManager(mLayoutManager);
        recyclerView.addItemDecoration(new CandidateFavourites.GridSpacingItemDecoration(2, dpToPx(10), true));
...
//
//                    Picasso.with(CandidateFavourites.this).load(cover)
//                            .fit()
//                            .centerCrop()
...
//                            .into(coverphoto);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(CandidateFavourites.this,error.getMessage(), Toast.LENGTH_LONG).show();
                hideDialog();
            }
        });
//
    ...
    public void loadData(String profile_id) {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < jUser.length(); i++)
                    {
                        ...
                        favViewList.add(new CandidateFavouritesModel("", c.getString("slug"),c.getString("photo_id"), c.getString("photo")));
                    }
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(CandidateFavourites.this);
