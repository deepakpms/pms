...
import com.cvvid.fragments.employer.EAddressFragment;
import com.cvvid.fragments.employer.ECustomUrl;
import com.cvvid.fragments.employer.EDetailsFragment;
import com.cvvid.fragments.employer.ESecurityFragment;
 ...
 */
public class InstituteSettingFragment extends Fragment {
    ...
    public InstituteSettingFragment() {
        // Required empty public constructor
    }

    public static Fragment newInstance()
    {
        InstituteSettingFragment myFragment = new InstituteSettingFragment();
        return myFragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_institute_setting, container, false);
        ...
        madapter.AddFragmentPage(new IDetailsFragment(), "Details");
        madapter.AddFragmentPage(new IAddressFragment(), "Address");
        madapter.AddFragmentPage(new ISecurityFragment(), "Security");
        madapter.AddFragmentPage(new ICustomUrl(), "Custom URL");
        ...
        final StringRequest strReq = new StringRequest(Request.Method.GET,
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    final CircleImageView imageView = (CircleImageView) view.findViewById(R.id.profile_image);

                    new DownloadImageTask((ImageView)view.findViewById(R.id.profile_image))
                            .execute(photo);

//                    String imageUri = "https://i.imgur.com/tGbaZCY.jpg";
//                    ImageView ivBasicImage = (ImageView)view.findViewById(R.id.profile_image);
//                    Picasso.with(getContext()).load(photo).into(ivBasicImage);
